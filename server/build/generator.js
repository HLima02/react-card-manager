    ...
    var result = [
        {
            ...
            beforeCreatedAt: "2012-12-14T11:23:05.635Z",
            beforeId: 1001,
            beforeMetadatas: { name: "Tiago Rodrigues", digits: 4405 },
            beforeDigits: 4405,
            beforeName: "Tiago Rodrigues",
            ...
            //   user_id: 1,
            // },
            afterCreatedAt: "2012-12-14T11:23:05.635Z",
            afterId: 1001,
            afterMetadatas: { name: "Tiago Rodrigues", digits: 4405 },
            afterDigits: 4405,
            afterName: "Tiago Rodrigues",
...
fs.writeFile("".concat(__dirname, "/db.json"), JSON.stringify(exports.db), function (err) {
    if (err) {
